...
import com.example.ze.constants.Constants.ALEXANDRIA_DARK_THEME
import com.example.ze.constants.Constants.ALEXANDRIA_LIGHT_THEME
import com.example.ze.constants.Constants.BERGAMA_DARK_THEME
import com.example.ze.constants.Constants.BERGAMA_LIGHT_THEME
import com.example.ze.constants.Constants.CHANGE_EMAIL
import com.example.ze.constants.Constants.CHANGE_PASSWORD
import com.example.ze.constants.Constants.LOGIN_INTENT
import com.example.ze.constants.Constants.MAIN_INTENT
import com.example.ze.constants.Constants.NINOVA_DARK_THEME
import com.example.ze.constants.Constants.NINOVA_LIGHT_THEME
import com.example.ze.constants.Constants.PRIVACY_POLICY_URL
import com.example.ze.constants.Constants.REGISTER
import com.example.ze.constants.Constants.REGISTER_INTENT
import com.example.ze.constants.Constants.SETTINGS_ACTION_KEY
import com.example.ze.constants.Constants.VERSION_NAME
import com.example.ze.constants.Response
import com.example.ze.databinding.CustomDialogPasswordLayoutBinding
        ...
        if (p1 == "theme") {
            when (themePref) {
                NINOVA_LIGHT_THEME -> {
                    ...
                    requireActivity().theme.applyStyle(R.style.Theme_ze_, true)
                ...
                NINOVA_DARK_THEME -> {
                    ...
                    requireActivity().theme.applyStyle(R.style.Theme_Elinia, true)
                    requireActivity().recreate()
